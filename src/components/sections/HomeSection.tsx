    ...
    <section className="animate-fade-in pb-12 mb-8 mt-4">
      <div className="flex flex-col-reverse md:flex-row items-center md:items-start justify-between gap-12 md:gap-8">
        ...
        <div className="flex-1 w-full flex flex-col justify-center items-center md:items-start text-center md:text-left mt-4 md:mt-0">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold mb-6 animate-fade-in text-muted-foreground flex items-center justify-center md:justify-start min-h-[40px] sm:min-h-[48px] lg:min-h-[56px]" style={{ animationDelay: "50ms" }}>
          ...
          <div className="flex flex-row justify-center md:justify-start gap-5 sm:gap-10 mt-4 animate-fade-in" style={{ animationDelay: "200ms" }}>
            <div className="flex items-center gap-4 group">
              ...
              <span className="text-sm font-medium text-muted-foreground leading-tight text-left uppercase tracking-wider">Years<br />Experience</span>
            </div>
            ...
            <div className="flex items-center gap-4 group">
              ...
              <span className="text-sm font-medium text-muted-foreground leading-tight text-left uppercase tracking-wider">Projects<br />Completed</span>
            </div>
          </div>
