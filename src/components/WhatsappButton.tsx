    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <button onClick={handleWhatsApp} className="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-emerald-600 dark:text-emerald-500 hover:bg-emerald-500/10 transition-colors w-full text-left">
          ...
          <button onClick={handleTelegram} className="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-sky-600 dark:text-sky-500 hover:bg-sky-500/10 transition-colors w-full text-left">
            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm5.56 8.61l-1.92 9.06c-.14.63-.52.79-1.04.5l-2.93-2.16-1.41 1.36c-.16.16-.29.29-.6.29l.21-3.01 5.48-4.95c.24-.22-.05-.34-.37-.13l-6.78 4.27-2.92-.91c-.64-.2-.65-.64.13-.94l11.39-4.39c.53-.19.99.13.79.96z" />
            </svg>
